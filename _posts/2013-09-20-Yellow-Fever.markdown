...
- 8,103 humans are categorized as 'vulnerable' for the outbreak. To calculate the number of people contracting Yellow Fever, the following formula was used:
 **# of Contagious Mosquitos * Bites/Day * Percent of Vulnerable Human Population** or [1,945 * 0.2 * 42.6] = 166 persons per day.
